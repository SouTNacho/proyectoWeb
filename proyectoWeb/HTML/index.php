        ...
        <div class="item1">
            <div class="header-conter">
                <div class="button-logout-conter">
                    <a href="logout.php" class="heder-logout-button">LOGOUT</a>
                </div>
                ...
                <div class="header-link-conter">
                    ...
                    <button class="header-button"><a class="header-button-link" href="">FORUM</a></button>
                </div>
        ...
        <div class="item3">
            <div class="footer-conter">
                ...
                <div class="footer-socialmedia">
                    <a href="" target="_blank"><img src="../SRC/ficon.png" alt="" class="sc-image"></a>
                    <a href="" target="_blank"><img src="../SRC/insta.png" alt="" class="sc-image"></a>
                    <a href="" target="_blank"><img src="../SRC/twiit.png" alt="" class="sc-image"></a>
                </div>
                <div class="footer-link">
                    <div class="flink-conter">
                        <div class="flink-container"><a href="" class="flink" target="_blank">TERMS</a></div>
                        ...
                        <div class="flink-container"><a href="" class="flink">FORUM</a></div>
                    </div>
                </div>
            </div>
        </div>
